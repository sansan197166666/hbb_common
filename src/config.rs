...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.248.75.188"];
pub const RS_PUB_KEY: &str = "MN6Y+aDaeXQsz8QAd+8ThELQEnnSwJp58gZB2qZe5DA=";
pub const RENDEZVOUS_PORT: i32 =32216;
pub const RELAY_PORT: i32 =32217;
pub const WS_RENDEZVOUS_PORT: i32 = 32218;
pub const WS_RELAY_PORT: i32 = 32219;
