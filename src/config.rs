...
pub const RENDEZVOUS_SERVERS: &[&str] = &["206.238.70.120"];
pub const RS_PUB_KEY: &str = "sekgoE5Zq0S8EtjetFGOnLnD+ctfmyC4l52vEExN+UM=";
pub const RENDEZVOUS_PORT: i32 =57316;
pub const RELAY_PORT: i32 = 57317;
pub const WS_RENDEZVOUS_PORT: i32 = 57318;
pub const WS_RELAY_PORT: i32 = 57319;
