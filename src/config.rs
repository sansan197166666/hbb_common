...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.248.78.252"];
pub const RS_PUB_KEY: &str = "2ueRNs4dLSNAz3HZLAuFA8NJJWsKuteHoDdj2fEvpm0=";
pub const RENDEZVOUS_PORT: i32 =64116;
pub const RELAY_PORT: i32 =64117;
pub const WS_RENDEZVOUS_PORT: i32 = 64118;
pub const WS_RELAY_PORT: i32 = 64119;
