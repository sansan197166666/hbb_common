...
pub const RENDEZVOUS_SERVERS: &[&str] = &["206.238.68.33"];
pub const RS_PUB_KEY: &str = "wpSy+rCOarCbrkmSK2ACCuZNIsalo3a5cJbAWUL4tm0=";
pub const RENDEZVOUS_PORT: i32 =8676;
pub const RELAY_PORT: i32 =8677;
pub const WS_RENDEZVOUS_PORT: i32 = 8678;
pub const WS_RELAY_PORT: i32 = 8679;
